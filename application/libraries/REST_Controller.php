...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        $this->load->helper(array('security','template', 'commont','ajax','uri','menu','forms', 'taxonomy', 'metabox', 'email', 'plugin'));
        ...
        $this->_get_args = array_merge($this->_get_args, $this->uri->uri_to_assoc());
    ...
    protected function _parse_get()
    {
        ...
        if(!is_array($this->_query_args)) $this->_query_args = array();
